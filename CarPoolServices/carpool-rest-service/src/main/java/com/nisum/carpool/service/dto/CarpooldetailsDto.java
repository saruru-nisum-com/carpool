...
public class CarpooldetailsDto {
	...
	public String toString() {
		return "CarpooldetailsDto [id=" + id + ", parentid=" + parentid + ", emailId=" + emailId + ", vehicleType="
				...
				+ ", startTime=" + startTime + ", toTime=" + toTime + ", status=" + status + ", rewards=" + rewards
				+ ", createddate=" + createddate + ", modifieddate=" + modifieddate + ", location=" + location
				+ ", latitude=" + latitude + ", longitude=" + longitude + ", statusId]";
	}
}
